...
.engine.logic.contract.quanto.ExecCost               :{[price;qty;multiplier]
...
.engine.logic.contract.quanto.AvgPrice               :{[isignum;execCost;totalEntry;multiplier]
...
.engine.logic.contract.quanto.UnrealizedPnl          :{[amt;isignum;avgPrice;markPrice;faceValue;multiplier] // todo return multiplier val
...
.engine.logic.contract.quanto.RealizedPnl            :{[fillQty;fillPrice;isignum;avgPrice;faceValue;multiplier]
