...
namespace TypeDefault {
  ...
  Tensor & arccos_out_out(Tensor & out, const Tensor & self);
  ...
  Tensor & clip_out_out(Tensor & out, const Tensor & self, c10::optional<Scalar> min, c10::optional<Scalar> max);
  ...
  Tensor _convolution(const Tensor & input, const Tensor & weight, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool transposed, IntArrayRef output_padding, int64_t groups, bool benchmark, bool deterministic, bool cudnn_enabled, bool allow_tf32);
  Tensor _convolution_deprecated(const Tensor & input, const Tensor & weight, const Tensor & bias, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool transposed, IntArrayRef output_padding, int64_t groups, bool benchmark, bool deterministic, bool cudnn_enabled);
  ...
  std::tuple<Tensor,Tensor,Tensor> _convolution_double_backward(const Tensor & ggI, const Tensor & ggW, const Tensor & ggb, const Tensor & gO, const Tensor & weight, const Tensor & self, IntArrayRef stride, IntArrayRef padding, IntArrayRef dilation, bool transposed, IntArrayRef output_padding, int64_t groups, bool benchmark, bool deterministic, bool cudnn_enabled, bool allow_tf32, std::array<bool,3> output_mask);
  ...
  Tensor divide_Tensor(const Tensor & self, const Tensor & other);
  Tensor & divide__Tensor(Tensor & self, const Tensor & other);
  Tensor & divide_out_out(Tensor & out, const Tensor & self, const Tensor & other);
  Tensor divide_Scalar(const Tensor & self, Scalar other);
  Tensor & divide__Scalar(Tensor & self, Scalar other);
  ...
  Tensor & vdot_out_out(Tensor & out, const Tensor & self, const Tensor & other);
  ...
  std::tuple<Tensor,Tensor> rowwise_prune(const Tensor & weight, const Tensor & mask, ScalarType compressed_indices_dtype);
  ...
  Tensor unflatten_int(const Tensor & self, int64_t dim, IntArrayRef sizes, c10::optional<DimnameList> names);
  ...
  std::tuple<Tensor,Tensor> _grid_sampler_2d_cpu_fallback_backward(const Tensor & grad_output, const Tensor & input, const Tensor & grid, int64_t interpolation_mode, int64_t padding_mode, bool align_corners);
  ...
  Tensor kaiser_window_periodic(int64_t window_length, bool periodic, const TensorOptions & options);
  Tensor kaiser_window_beta(int64_t window_length, bool periodic, double beta, const TensorOptions & options);
  ...
  Tensor linspace(Scalar start, Scalar end, c10::optional<int64_t> steps, const TensorOptions & options);
  ...
  Tensor logspace(Scalar start, Scalar end, c10::optional<int64_t> steps, double base, const TensorOptions & options);
  ...
  Tensor multiply_Tensor(const Tensor & self, const Tensor & other);
  Tensor & multiply__Tensor(Tensor & self, const Tensor & other);
  Tensor & multiply_out_out(Tensor & out, const Tensor & self, const Tensor & other);
  Tensor multiply_Scalar(const Tensor & self, Scalar other);
  Tensor & multiply__Scalar(Tensor & self, Scalar other);
  ...
  Tensor & negative_out_out(Tensor & out, const Tensor & self);
  ...
  Tensor & hstack_out_out(Tensor & out, TensorList tensors);
  Tensor vstack(TensorList tensors);
  Tensor & vstack_out_out(Tensor & out, TensorList tensors);
  Tensor dstack(TensorList tensors);
  Tensor & dstack_out_out(Tensor & out, TensorList tensors);
  Tensor stft(const Tensor & self, int64_t n_fft, c10::optional<int64_t> hop_length, c10::optional<int64_t> win_length, const Tensor & window, bool normalized, c10::optional<bool> onesided, c10::optional<bool> return_complex);
  Tensor istft(const Tensor & self, int64_t n_fft, c10::optional<int64_t> hop_length, c10::optional<int64_t> win_length, const Tensor & window, bool center, bool normalized, c10::optional<bool> onesided, c10::optional<int64_t> length, bool return_complex);
  ...
  Tensor & fix_out_out(Tensor & out, const Tensor & self);
  ...
  Tensor & subtract_out_out(Tensor & out, const Tensor & self, const Tensor & other, Scalar alpha);
  Tensor subtract_Tensor(const Tensor & self, const Tensor & other, Scalar alpha);
  Tensor & subtract__Tensor(Tensor & self, const Tensor & other, Scalar alpha);
  Tensor subtract_Scalar(const Tensor & self, Scalar other, Scalar alpha);
  Tensor & subtract__Scalar(Tensor & self, Scalar other, Scalar alpha);
  ...
  std::tuple<double,double> choose_qparams_optimized(const Tensor & input, int64_t numel, int64_t n_bins, double ratio, int64_t bit_width);
  ...
  Tensor & not_equal_out_Scalar_out(Tensor & out, const Tensor & self, Scalar other);
  Tensor not_equal_Scalar(const Tensor & self, Scalar other);
  Tensor & not_equal_out_Tensor_out(Tensor & out, const Tensor & self, const Tensor & other);
  Tensor not_equal_Tensor(const Tensor & self, const Tensor & other);
  Tensor & not_equal__Scalar(Tensor & self, Scalar other);
  Tensor & not_equal__Tensor(Tensor & self, const Tensor & other);
  Tensor & ge__Scalar(Tensor & self, Scalar other);
  Tensor & ge__Tensor(Tensor & self, const Tensor & other);
  Tensor & greater_equal_out_Scalar_out(Tensor & out, const Tensor & self, Scalar other);
  Tensor greater_equal_Scalar(const Tensor & self, Scalar other);
  Tensor & greater_equal_out_Tensor_out(Tensor & out, const Tensor & self, const Tensor & other);
  Tensor greater_equal_Tensor(const Tensor & self, const Tensor & other);
  Tensor & greater_equal__Scalar(Tensor & self, Scalar other);
  Tensor & greater_equal__Tensor(Tensor & self, const Tensor & other);
  Tensor & le__Scalar(Tensor & self, Scalar other);
  Tensor & le__Tensor(Tensor & self, const Tensor & other);
  Tensor & less_equal_out_Scalar_out(Tensor & out, const Tensor & self, Scalar other);
  Tensor less_equal_Scalar(const Tensor & self, Scalar other);
  Tensor & less_equal_out_Tensor_out(Tensor & out, const Tensor & self, const Tensor & other);
  Tensor less_equal_Tensor(const Tensor & self, const Tensor & other);
  Tensor & less_equal__Scalar(Tensor & self, Scalar other);
  Tensor & less_equal__Tensor(Tensor & self, const Tensor & other);
  Tensor & gt__Scalar(Tensor & self, Scalar other);
  Tensor & gt__Tensor(Tensor & self, const Tensor & other);
  Tensor & greater_out_Scalar_out(Tensor & out, const Tensor & self, Scalar other);
  Tensor greater_Scalar(const Tensor & self, Scalar other);
  Tensor & greater_out_Tensor_out(Tensor & out, const Tensor & self, const Tensor & other);
  Tensor greater_Tensor(const Tensor & self, const Tensor & other);
  Tensor & greater__Scalar(Tensor & self, Scalar other);
  Tensor & greater__Tensor(Tensor & self, const Tensor & other);
  Tensor & lt__Scalar(Tensor & self, Scalar other);
  Tensor & lt__Tensor(Tensor & self, const Tensor & other);
  Tensor & less_out_Scalar_out(Tensor & out, const Tensor & self, Scalar other);
  Tensor less_Scalar(const Tensor & self, Scalar other);
  Tensor & less_out_Tensor_out(Tensor & out, const Tensor & self, const Tensor & other);
  Tensor less_Tensor(const Tensor & self, const Tensor & other);
  Tensor & less__Scalar(Tensor & self, Scalar other);
  Tensor & less__Tensor(Tensor & self, const Tensor & other);
  ...
  Tensor & quantile_out_scalar_out(Tensor & out, const Tensor & self, double q, c10::optional<int64_t> dim, bool keepdim);
  Tensor quantile_scalar(const Tensor & self, double q, c10::optional<int64_t> dim, bool keepdim);
  Tensor & quantile_out_out(Tensor & out, const Tensor & self, const Tensor & q, c10::optional<int64_t> dim, bool keepdim);
  Tensor quantile(const Tensor & self, const Tensor & q, c10::optional<int64_t> dim, bool keepdim);
  Tensor & nanquantile_out_scalar_out(Tensor & out, const Tensor & self, double q, c10::optional<int64_t> dim, bool keepdim);
  Tensor nanquantile_scalar(const Tensor & self, double q, c10::optional<int64_t> dim, bool keepdim);
  Tensor & nanquantile_out_out(Tensor & out, const Tensor & self, const Tensor & q, c10::optional<int64_t> dim, bool keepdim);
  ...
  Tensor & outer_out_out(Tensor & out, const Tensor & self, const Tensor & vec2);
  ...
  Tensor linalg_norm_ord_str(const Tensor & self, std::string ord, c10::optional<IntArrayRef> dim, bool keepdim, c10::optional<ScalarType> dtype);
  Tensor & linalg_norm_out_out(Tensor & out, const Tensor & self, c10::optional<Scalar> ord, c10::optional<IntArrayRef> dim, bool keepdim, c10::optional<ScalarType> dtype);
  Tensor & linalg_norm_out_ord_str_out(Tensor & out, const Tensor & self, std::string ord, c10::optional<IntArrayRef> dim, bool keepdim, c10::optional<ScalarType> dtype);
