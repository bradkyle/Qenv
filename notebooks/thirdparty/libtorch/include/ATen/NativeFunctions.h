...
CAFFE2_API std::tuple<double,double> choose_qparams_optimized(const Tensor & input, int64_t numel, int64_t n_bins, double ratio, int64_t bit_width);
...
CAFFE2_API std::vector<Tensor> foreach_tensor_div_list_kernel_slow(TensorList self, TensorList other);
CAFFE2_API std::vector<Tensor> foreach_tensor_div_list_kernel_cuda(TensorList self, TensorList other);
...
CAFFE2_API void foreach_tensor_addcdiv_slow_(TensorList self, TensorList tensor1, TensorList tensor2, Scalar value=1);
CAFFE2_API void foreach_tensor_addcdiv_cuda_(TensorList self, TensorList tensor1, TensorList tensor2, Scalar value=1);
CAFFE2_API void foreach_tensor_addcmul_slow_(TensorList self, TensorList tensor1, TensorList tensor2, Scalar value=1);
CAFFE2_API void foreach_tensor_addcmul_cuda_(TensorList self, TensorList tensor1, TensorList tensor2, Scalar value=1);
CAFFE2_API std::vector<Tensor> foreach_tensor_addcdiv_slow(TensorList input, TensorList tensor1, TensorList tensor2, Scalar value=1);
CAFFE2_API std::vector<Tensor> foreach_tensor_addcdiv_cuda(TensorList input, TensorList tensor1, TensorList tensor2, Scalar value=1);
CAFFE2_API std::vector<Tensor> foreach_tensor_addcmul_slow(TensorList input, TensorList tensor1, TensorList tensor2, Scalar value=1);
CAFFE2_API std::vector<Tensor> foreach_tensor_addcmul_cuda(TensorList input, TensorList tensor1, TensorList tensor2, Scalar value=1);
...
CAFFE2_API Tensor heaky_relu_quantized_cpu(const Tensor & self, Scalar negative_slope=0.01);
...
CAFFE2_API Tensor upsample_nearest1d_cpu(const Tensor & input, c10::optional<IntArrayRef> output_size, c10::optional<ArrayRef<double>> scale_factors);
CAFFE2_API Tensor upsample_nearest1d_cuda(const Tensor & input, c10::optional<IntArrayRef> output_size, c10::optional<ArrayRef<double>> scale_factors);
CAFFE2_API Tensor upsample_nearest1d_backward_cpu(const Tensor & grad_output, c10::optional<IntArrayRef> output_size, IntArrayRef input_size, c10::optional<ArrayRef<double>> scale_factors);
CAFFE2_API Tensor upsample_nearest1d_backward_cuda(const Tensor & grad_output, c10::optional<IntArrayRef> output_size, IntArrayRef input_size, c10::optional<ArrayRef<double>> scale_factors);
