...
namespace CPUType {
  ...
  Tensor add_relu_Tensor(const Tensor & self, const Tensor & other, Scalar alpha);
  Tensor & add_relu__Tensor(Tensor & self, const Tensor & other, Scalar alpha);
  Tensor & add_relu_out_out(Tensor & out, const Tensor & self, const Tensor & other, Scalar alpha);
